...
% Tu peux changer le theme ici, regarde sur internet pour les noms des themes.
\usetheme{Malmoe}

% Ca c'est pour mettre des cercles pour les puces des listes.
\setbeamertemplate{subsection in toc}[circle]
\setbeamertemplate{section in toc}[circle]

% Y'a pleins d'autres commandes pour changer des parametres, regarde sur
% internet pour les trouver :)
...
% Une frame qui contient le titre
\begin{frame}
  \titlepage
\end{frame}
